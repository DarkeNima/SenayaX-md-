...
cmd({
  ...
  try {
    ...
    const apiUrl = `https://www.dark-yasiya-api.site/movie/sinhalasub/search?text=${encodeURIComponent(q)}`;
    ...
    // Fetching the top 10 results
    const topResults = data.result.data.slice(0, 10);
    let resultMessage = " *`Qᴜᴇᴇɴ x ꜱᴇɴᴀʏᴀ ᴍᴅ ᴍᴏᴠɪᴇ ꜱᴇʀᴄʜ ʀᴇꜱᴜʟᴛ ꜰᴏʀ 📍`*  \"" + q + "\":\n\n";
